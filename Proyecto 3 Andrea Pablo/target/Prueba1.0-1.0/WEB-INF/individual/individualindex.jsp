    ...
    <body>   
       ...
       <div class="cuerpo col-sm-9 " style="margin-left: 100px" >
            <form action="IndividualCtrl" method="GET">
               <div class="col-sm-9"> 
               <h3 class="titulo" style="margin-left: 10px">Lista de Individuales</h3>  
             ...
             <div style="margin-left:20px;" >
                   <c:forEach items="${individuales}" var="individual">
                        <div class="col-sm-4 item" style="padding-top:15px;">
                            <div class="card ">
                                <div class="card-body">
                                    <h4 class="card-title" style="text-transform: uppercase; font-weight: 600;">${individual.nombre}</h4>
