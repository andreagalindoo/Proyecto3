        ...
        <div class="container" style="margin-top: 5px; ">
            ...
            <div style="margin-left:45%;" >
                <div class="col-sm-12 item" style="padding-top:0px;" >
                    <div class="card ">
                        <div class="card-body">
                            <h3 class="card-title" style="text-transform: uppercase; font-weight: 500;">Orden ${orden.id}</h3>
                            ...
                            <div>
                                <h4 class="card-text"  style="text-transform: uppercase; font-weight: 500;">Datos Del Cliente</h4>
                            ...
                            <div>
                                <h4 class="card-text"  style="text-transform: uppercase; font-weight: 500;">Datos Del Producto 1</h4>
                            ...
                            <div>
                                <h4 class="card-text"  style="text-transform: uppercase; font-weight: 500;">Datos Del Producto 2</h4>
