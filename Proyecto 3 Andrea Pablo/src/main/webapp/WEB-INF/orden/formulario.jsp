    ...
    <body>
        ...
        <jsp:include page="../includes/header.jsp"></jsp:include>
            ...
            <div  class="cuerpo" style="margin:15px 300px 100px 300px;
                ...
                <h3 class="titulo" style="padding-bottom:10px"><%=tipoForm%> Orden ${orden.id}</h3>
            <form action="OrdenCtrl" method="POST">
              ...
              <div style="padding: 5px 10px 5px 10px">
               ...
               <div style="padding: 5px 10px 15px 10px">
                ...
                <input type="submit" class="btn btn-success" style="margin-left:10px;" value="<%=tipoForm%>" name="accion" >
            </form>
        </div>
    </body>
</html>
